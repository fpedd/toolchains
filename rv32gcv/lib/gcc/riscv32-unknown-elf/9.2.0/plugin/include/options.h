...
enum opt_code
{
  ...
  OPT_mabi_ = 1274,                          /* -mabi= */
  OPT_malign_data_ = 1275,                   /* -malign-data= */
  OPT_march_ = 1276,                         /* -march= */
  OPT_mbranch_cost_ = 1277,                  /* -mbranch-cost= */
  OPT_mcmodel_ = 1278,                       /* -mcmodel= */
  OPT_mdiv = 1279,                           /* -mdiv */
  OPT_mexplicit_relocs = 1280,               /* -mexplicit-relocs */
  OPT_mfdiv = 1281,                          /* -mfdiv */
  OPT_mplt = 1282,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1283,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1284,                         /* -mrelax */
  OPT_mriscv_attribute = 1285,               /* -mriscv-attribute */
  OPT_msave_restore = 1286,                  /* -msave-restore */
  OPT_msmall_data_limit_ = 1287,             /* -msmall-data-limit= */
  OPT_mstrict_align = 1288,                  /* -mstrict-align */
  OPT_mtune_ = 1289,                         /* -mtune= */
  OPT_n = 1290,                              /* -n */
  OPT_no_canonical_prefixes = 1291,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1292,              /* -no-integrated-cpp */
  OPT_no_pie = 1293,                         /* -no-pie */
  OPT_nocpp = 1294,                          /* -nocpp */
  OPT_nodefaultlibs = 1295,                  /* -nodefaultlibs */
  OPT_nolibc = 1296,                         /* -nolibc */
  OPT_nophoboslib = 1297,                    /* -nophoboslib */
  OPT_nostartfiles = 1298,                   /* -nostartfiles */
  OPT_nostdinc = 1299,                       /* -nostdinc */
  OPT_nostdinc__ = 1300,                     /* -nostdinc++ */
  OPT_nostdlib = 1301,                       /* -nostdlib */
  OPT_o = 1302,                              /* -o */
  OPT_p = 1303,                              /* -p */
  OPT_pass_exit_codes = 1304,                /* -pass-exit-codes */
  /* OPT_pedantic = 1305, */                 /* -pedantic */
  OPT_pedantic_errors = 1306,                /* -pedantic-errors */
  OPT_pg = 1307,                             /* -pg */
  OPT_pie = 1308,                            /* -pie */
  OPT_pipe = 1309,                           /* -pipe */
  OPT_print_file_name_ = 1310,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1311,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1312,          /* -print-multi-directory */
  OPT_print_multi_lib = 1313,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1314,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1315,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1316,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1317,               /* -print-prog-name= */
  OPT_print_search_dirs = 1318,              /* -print-search-dirs */
  OPT_print_sysroot = 1319,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1320,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1321,                          /* -quiet */
  OPT_r = 1322,                              /* -r */
  OPT_remap = 1323,                          /* -remap */
  OPT_s = 1324,                              /* -s */
  OPT_save_temps = 1325,                     /* -save-temps */
  OPT_save_temps_ = 1326,                    /* -save-temps= */
  OPT_shared = 1327,                         /* -shared */
  OPT_shared_libgcc = 1328,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1329,               /* -shared-libphobos */
  /* OPT_specs = 1330, */                    /* -specs */
  OPT_specs_ = 1331,                         /* -specs= */
  OPT_static = 1332,                         /* -static */
  OPT_static_libasan = 1333,                 /* -static-libasan */
  OPT_static_libgcc = 1334,                  /* -static-libgcc */
  OPT_static_libgfortran = 1335,             /* -static-libgfortran */
  OPT_static_libgo = 1336,                   /* -static-libgo */
  OPT_static_liblsan = 1337,                 /* -static-liblsan */
  OPT_static_libmpx = 1338,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1339,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1340,               /* -static-libphobos */
  OPT_static_libstdc__ = 1341,               /* -static-libstdc++ */
  OPT_static_libtsan = 1342,                 /* -static-libtsan */
  OPT_static_libubsan = 1343,                /* -static-libubsan */
  OPT_static_pie = 1344,                     /* -static-pie */
  /* OPT_std_c__03 = 1345, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1346, */                /* -std=c++0x */
  OPT_std_c__11 = 1347,                      /* -std=c++11 */
  OPT_std_c__14 = 1348,                      /* -std=c++14 */
  OPT_std_c__17 = 1349,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1350, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1351, */                /* -std=c++1z */
  OPT_std_c__2a = 1352,                      /* -std=c++2a */
  OPT_std_c__98 = 1353,                      /* -std=c++98 */
  OPT_std_c11 = 1354,                        /* -std=c11 */
  OPT_std_c17 = 1355,                        /* -std=c17 */
  /* OPT_std_c18 = 1356, */                  /* -std=c18 */
  /* OPT_std_c1x = 1357, */                  /* -std=c1x */
  OPT_std_c2x = 1358,                        /* -std=c2x */
  /* OPT_std_c89 = 1359, */                  /* -std=c89 */
  OPT_std_c90 = 1360,                        /* -std=c90 */
  OPT_std_c99 = 1361,                        /* -std=c99 */
  /* OPT_std_c9x = 1362, */                  /* -std=c9x */
  OPT_std_f2003 = 1363,                      /* -std=f2003 */
  OPT_std_f2008 = 1364,                      /* -std=f2008 */
  OPT_std_f2008ts = 1365,                    /* -std=f2008ts */
  OPT_std_f2018 = 1366,                      /* -std=f2018 */
  OPT_std_f95 = 1367,                        /* -std=f95 */
  OPT_std_gnu = 1368,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1369, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1370, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1371,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1372,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1373,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1374, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1375, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1376,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1377,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1378,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1379,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1380, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1381, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1382,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1383, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1384,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1385,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1386, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1387, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1388,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1389, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1390, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1391, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1392, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1393, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1394,                     /* -std=legacy */
  OPT_symbolic = 1395,                       /* -symbolic */
  OPT_t = 1396,                              /* -t */
  OPT_time = 1397,                           /* -time */
  OPT_time_ = 1398,                          /* -time= */
  OPT_traditional = 1399,                    /* -traditional */
  OPT_traditional_cpp = 1400,                /* -traditional-cpp */
  OPT_trigraphs = 1401,                      /* -trigraphs */
  OPT_u = 1402,                              /* -u */
  OPT_undef = 1403,                          /* -undef */
  OPT_v = 1404,                              /* -v */
  OPT_version = 1405,                        /* -version */
  OPT_w = 1406,                              /* -w */
  OPT_wrapper = 1407,                        /* -wrapper */
  OPT_x = 1408,                              /* -x */
  OPT_z = 1409,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
